...
// "Функция сложения двух чисел: sum(1)(2) //3"
...
// "const arr = [1, 2, 3, 4, 5]; arr.forEach(cb(10)); // 11 12 13 14"
...
function reverseInt(value) {
    ...
    const isNegative = splitedArray.indexOf('-');
    ...
    const reversedInt = +splitedArray.join('');
    return reversedInt;
}

/* "Вывести самую частую символ
